...
import com.cpcjrcoding.chirp.infra.database.mappers.toEmailVerificationToken
import com.cpcjrcoding.chirp.infra.database.mappers.toUser
import com.cpcjrcoding.chirp.infra.database.repositories.EmailVerificationTokenRepository
...
class EmailVerificationService(
    ...
    fun createVerificationToken(email: String): EmailVerificationToken {
        ...
        val existingTokens =
            emailVerificationTokenRepository.findByUserAndUsedAtIsNull(
                user = userEntity,
            )
