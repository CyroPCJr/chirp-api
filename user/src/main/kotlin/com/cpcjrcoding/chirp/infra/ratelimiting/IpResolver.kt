package com.cpcjrcoding.chirp.infra.ratelimiting

import com.cpcjrcoding.chirp.infra.config.NginxConfig
...
class IpResolver(
    ...
    private fun extractFromXRealIp(
        ...
        request.getHeader("X-Real-IP")?.let { header ->
